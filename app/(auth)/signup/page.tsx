      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            onBlur={validate}
            placeholder="もう一度入力"
            className={`h-12 w-full rounded-xl border-0 bg-surface px-4 text-sm text-primary placeholder:text-muted/60 focus:outline-none focus:ring-2 ${errors.confirm ? "ring-2 ring-danger" : "focus:ring-accent/40"}`}
          />
